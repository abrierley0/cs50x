...
{
    struct person *parents[2];  // Pointer to two other person struct
...
person *create_family(int generations)
{
    // INDIVIDUAL PERSON - USING RECURSION
    ...
    if (generations > 1)
    {
        ...
        // Randomly select an index from the alleles of the parents
        new_person->alleles[0] = parent0->alleles[rand() % 2];
        new_person->alleles[1] = parent1->alleles[rand() % 2];
        // Note, do not need to consider dominant alleles
    }
